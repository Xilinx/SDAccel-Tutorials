...
This throughput goal is well within the bounds of maximum achievable throughput of an Alveo card. This tutorial will walk you through a predictable process for achieving that goal.
