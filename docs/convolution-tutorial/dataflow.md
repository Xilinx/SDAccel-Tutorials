...
The following figure shows the Profile Summary report for hardware emulation. The kernel execution time is now reduced to 0.059 ms.

![][dataflow_hwemu_profilesummary]

Here is the updated table. There is a 7.8x boost on kernel execution time perspective.
